...
struct MessagingView: View {
    ...
    func sendCustomEvent() {
        ...
        xdmData["eventType"] = "customAction"
        xdmData["_aemonacpprodcampaign"] = ["custom_action" : customEvent]
        
        if !customEvent.isEmpty {
            let experienceEvent = ExperienceEvent(xdm: xdmData, datasetIdentifier: AppDelegate.CUSTOM_ACTION_DATASET)
